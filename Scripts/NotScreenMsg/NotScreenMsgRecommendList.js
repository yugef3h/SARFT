function NotScreenMsgRecommendList() { }
var totalPage;
var totalRecords;
var now = new Date();
...
var url = "";
var data = "";
NotScreenMsgRecommendList.prototype = {
    //查询 
        ...
        success: function (resultInfo) {
            ...
            if (resultInfo.Result > 0) {
                ...
                for (var i = 0; i < da.Data.length; i++) {
                    ...
                    html += "<td> <button type='button' class='am-btn am-btn-primary am-btn-md' onclick='cancelReport(" + da.Data[i].Id + ")'>取消推荐</button></td>";
                    html += "</tr>";
                }
                $("#tables").html(html);
            } else {
    ...
    if (TotalCount >= 0) {
        ...
        kkpager.generPageHtml({
            ...
            click: function (n) {
                ...
                this.selectPage(n);
                pageIndex = n;
                selectPage(n, pageSize, $(".start").val(), $(".end").val(), 2, 0, 0, 0, 0, 0, 1, true);
                return false;
            }
...
var NotScreenMsgRecommendList = new NotScreenMsgRecommendList();