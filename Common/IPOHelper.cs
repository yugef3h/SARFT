...
public class IPOHelper
{
    ...
    public static ICellStyle Getcellstyle(IWorkbook wb, stylexls str)
    {
        ...
        cellStyle.BorderBottom = NPOI.SS.UserModel.CellBorderType.DOTTED;

        cellStyle.BorderLeft = NPOI.SS.UserModel.CellBorderType.HAIR;

        cellStyle.BorderRight = NPOI.SS.UserModel.CellBorderType.HAIR;

        cellStyle.BorderTop = NPOI.SS.UserModel.CellBorderType.DOTTED;
